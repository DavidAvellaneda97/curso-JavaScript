...
function cambiarColorPintiura(color){
    console.log('El color que llega a la funcion es ${color}'); // rojo
    color = "azul";
    console.log(`El color de la pintura que imprime la funcion es ${color}`); // azul
    return color;
}
...
function cambiarColorArreglo(arreglo){
    console.log(`El arreglo que llega a la funcion es ${arreglo}`); // "rojo", "azul", "verde"
    arreglo[0] = "negro";
    console.log(`Se imprimen los colores en la funcion: ${arreglo}`); // "rojo", "azul", "verde"
...
console.log( numbers.sort( ordenarNumero) );
// [1,10      3,100,5];
// [1,3      10,100,5];
// [1,3,10,100     ,5];
// [1,3,10,5,     100];
// ... despues de repetir las iteraciones nuevamente 
// [1,3,5,10,100 ];

const ordenarNumerosSimplificado = (numA, numB) => numA - numB;
const otrosNumeros = [ 1,  10,  3,  100,  5];
console.log( otrosNumeros.sort( ordenarNumerosSimplificando) ); // [1, 3, 5, 10,100]

const nunmerosDeLaSuerte = [ 7,  21,  14,  28,  35];
console.log( nunmerosDeLaSuerte.sort((a,b)=> a-b ) );
console.log( nunmerosDeLaSuerte.sort( function(a,b){return a-b} ) );
